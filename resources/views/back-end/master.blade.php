...
<head>
    ...
    <link href="{{asset('back-end-assets')}}/css/sb-admin-2.min.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        @include('back-end.include.left-side')
        <!-- End of Sidebar -->
    ...
    <script src="{{asset('back-end-assets')}}/js/sb-admin-2.min.js"></script>
    ...
    <script src="{{asset('back-end-assets')}}/js/demo/chart-pie-demo.js"></script>
